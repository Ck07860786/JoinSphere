...
function UserDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-blue-50 flex flex-row items-start justify-center py-12">
     
      <div className="w-96 h-svh bg-white rounded-xl shadow-lg p-6 mr-8">
    ...
    Total Friend ({friends.length}) 
      ...
      <div className="flex-grow max-w-4xl w-full flex flex-col items-center px-4">
        

        <form
          onSubmit={handleSearch}
          className="w-full max-w-lg flex space-x-3 items-center bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-shadow"
        >
          <input
            type="text"
        ...
        {!loading && searchResults.length > 0 && (
          <div className="w-full max-w-3xl bg-white rounded-xl shadow-lg p-6 mt-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">
              Search Results
            </h2>
                  ...
                  <div className="flex space-x-4">
                    {user.requestSent ? (
                      ...
                      <button
                        ...
                        className="px-5 py-2 font-medium rounded-full transition-all bg-gradient-to-r from-green-500 to-teal-500 text-white hover:from-green-600 hover:to-teal-600 shadow-md hover:shadow-lg"
                      >
                        Add Friend
                      </button>
                    )}
